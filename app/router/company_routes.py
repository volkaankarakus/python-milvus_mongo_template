...
from app.model.company_model import Company,CompanyResponse
...
async def create_company(
    ...
    try:
        ...
        return {"status": "success", "company": created_company}
...
async def update_company(
    ...
    try:
        ...
        if updated_company:
            return {"status": "success", "company": updated_company}
        else:
            raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail="Company not found")
...
async def get_all_companies(controller: CompanyController = Depends(CompanyController)):
    ...
    return {"status": "success", "company": all_companies}
